...
/**
 * cd_dot - Changes the current working directory to the parent directory or remains in the same directory.
...
/**
 * cd_to_home - Changes the current working directory to the user's home directory.
 * @datash: Pointer to the data_shell structure.
 * Return: None.
 */
