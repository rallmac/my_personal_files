...
/**
 * cmp_env_name - Compares the name of an environment variable with a given name.
 * @nenv: Pointer to the environment variable string.
 * @name: Pointer to the name to compare.
 * Return: Returns the number of characters matched up to the '=' character if the names match, otherwise 0.
 */
