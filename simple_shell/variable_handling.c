...
/**
 * check_env - Checks if the given input corresponds to an environment variable.
...
/**
 * check_vars - Checks for variables in the input string and replaces them with their values.
